 ...
 * Dong.L 2020/5/20 17:17 v1.0.0 初始创建
 *
 * **************************************************************
 */
 ...
 * @CreateDate: Created in 2020/5/20 17:17
 * @Author: Dong.L
 **/
@Slf4j
@Component
@ReqType(ReqTypeEnum.UPLOAD)
public class UploadHandler extends AbstractReqTypeHandler {
    @Override
