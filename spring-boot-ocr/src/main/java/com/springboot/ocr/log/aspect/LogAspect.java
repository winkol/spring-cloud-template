package com.springboot.ocr.log.aspect;

import com.springboot.ocr.log.annotation.ControllerLog;
import com.springboot.ocr.log.annotation.ServiceLog;
...
//    UserService userService;
     ...
     * Service层切面
     */
    @Pointcut("@annotation(com.springboot.ocr.log.annotation.ServiceLog)")
     ...
     * Controller层切面
     */
    @Pointcut("@annotation(com.springboot.ocr.log.annotation.ControllerLog)")
